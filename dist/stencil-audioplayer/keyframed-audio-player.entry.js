import { r as registerInstance, h } from './chunk-8c173cc0.js';
...
class MyComponent {
    ...
    render() {
        return h("div", { class: "audioplayer" }, h("div", { class: "timeline", onClick: this.handleTimeSeek }, h("div", { class: "progress-bar", style: { width: this.getWidth() } })), h("div", { class: "body" }, h("div", { class: "play-container" }, h("div", { class: (this.isPlaying ? "play" : "pause") + " btn", onClick: this.togglePlay })), h("div", { class: "name" }, this.name), h("div", { class: "time" }, this.getTime())));
    }
    static get style() { return ".audioplayer {\n  height: 50px;\n  font-family: Arial, Helvetica, sans-serif;\n  background: #223143;\n  color: white;\n\n  display: grid;\n  grid-template-rows: auto 1fr;\n}\n\n.timeline {\n  cursor: pointer;\n  height: 10px;\n  background: rgb(226, 226, 226);\n}\n\n.progress-bar {\n  height: 100%;\n  width: 0%;\n  background: coral;\n  -webkit-transition: .5s;\n  transition: .5s;\n}\n\n.body {\n  display: grid;\n  grid-template-columns: auto 1fr auto;\n  grid-gap: 10px;\n  -ms-flex-line-pack: center;\n  align-content: center;\n}\n\n.body > * {\n  padding: 5px 20px;\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-pack: center;\n  justify-content: center;\n  -ms-flex-align: center;\n  align-items: center;\n}\n\n.name {\n  text-align: center;\n}\n\n.btn {\n  cursor: pointer;\n}\n\n.play-container {\n  width: 20px;\n}\n\n.play {\n  border: 7px solid transparent;\n  border-left: 12px solid #fff;\n  position: relative;\n  right: -4px;\n}\n\n\n.pause:before,\n.pause:after {\n  content: \"\";\n  position: absolute;\n  width: 3px;\n  top: 0;\n  bottom: 0;\n  background: #fff;\n}\n.pause {\n  height: 13px;\n  width: 11px;\n  position: relative;\n}\n.pause:before {\n  left: 0;\n}\n.pause:after {\n  right: 0;\n}"; }
}

export { MyComponent as keyframed_audio_player };
